...
struct Seed {
    ...
    std::array<AppConsts::GeneType, 6> genes_ = {
...
struct SeedPtrEqual {
    bool operator()(const std::shared_ptr<Seed> &a,
                    const std::shared_ptr<Seed> &b) const {
...
struct SeedPtrHash {
    size_t operator()(const std::shared_ptr<Seed> &s) const {
